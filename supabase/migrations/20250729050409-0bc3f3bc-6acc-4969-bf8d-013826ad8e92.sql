-- Create function to edit AI usage and quota (admin only) - Fixed parameter order
...
GRANT EXECUTE ON FUNCTION public.admin_edit_ai_usage(UUID, UUID, INTEGER, INTEGER) TO authenticated;